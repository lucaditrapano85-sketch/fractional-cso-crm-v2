var AZIONI_TARGET_BY_SETTORE = 
{
  "manifatturiero_meccanica": {
    "vendite": {
      "1-2": "Identifica 1-2 tecnici interni che ti affiancano nelle visite cliente e nei preventivi — nessun costo aggiuntivo, operativo subito.",
      "2-3": "Attiva un agente plurimandatario con portafoglio clienti nella meccanica di precisione (~800-1.200€/mese di provvigioni) — operativo in 1-2 mesi.",
      "3-4": "Assumi un commerciale interno con portafoglio assegnato e obiettivi mensili (~2.500-3.500€/mese) — autonomo nelle trattative entro 3 mesi.",
      "4-5": "Struttura una direzione commerciale: responsabile vendite + agenti di zona + key account OEM (~6.000-9.000€/mese totale) — operativa in 6 mesi."
    },
    "pipeline": {
      "1-2": "Crea un registro offerte su Excel: cliente, lavorazione, importo, stato — nessun costo, operativo in una settimana.",
      "2-3": "Adotta un CRM base (Pipedrive o HubSpot free, ~30-50€/mese) per tracciare offerte, follow-up e storico cliente — operativo in 2 settimane.",
      "3-4": "Definisci SLA di risposta preventivi (max 48h) e monitora win/loss rate mensile — nessun costo aggiuntivo, richiede disciplina commerciale.",
      "4-5": "CRM integrato con gestione commesse, tempi produzione e fatturazione (~200-400€/mese) — operativo in 2-3 mesi con formazione."
    },
    "team": {
      "1-2": "Forma i tecnici sulla comunicazione commerciale base: come presentare capacità produttive e tempi di consegna — formazione interna, nessun costo.",
      "2-3": "Attiva incentivi per l'agente/commerciale legati al fatturato mensile — struttura un piano provvigionale chiaro entro il primo mese.",
      "3-4": "Assumi o nomina un responsabile commerciale interno (~3.000-4.000€/mese) che coordina agenti e gestisce i clienti strategici.",
      "4-5": "Struttura riunioni commerciali settimanali, KPI individuali e piano di formazione annuo — costo gestionale, nessun costo aggiuntivo rilevante."
    },
    "processi": {
      "1-2": "Standardizza il formato dei preventivi: copertina con capacità produttive, tempi di consegna garantiti e condizioni di pagamento — nessun costo.",
      "2-3": "Crea un listino interno per lavorazioni standard e una procedura di gestione delle varianti — risparmia tempo e riduce errori di pricing.",
      "3-4": "Implementa un gestionale di produzione integrato con la parte commerciale (~300-600€/mese) per tracciare stato commesse in tempo reale.",
      "4-5": "Certificazione qualità (ISO 9001 se non presente, ~5.000-15.000€ una tantum) e auditing periodico dei processi di offerta e consegna."
    },
    "ricavi": {
      "1-2": "Rivedi il pricing: calcola il costo reale di ogni lavorazione (ore macchina + manodopera + overhead) e verifica i margini reali — nessun costo.",
      "2-3": "Inserisci sistematicamente servizi accessori nell'offerta: trattamenti superficiali, assemblaggio, imballaggio speciale — upsell immediato.",
      "3-4": "Proponi contratti quadro annuali ai clienti principali con volumi minimi garantiti in cambio di prezzi stabili — protegge i margini.",
      "4-5": "Sviluppa un'offerta di servizi a valore aggiunto: prototipazione rapida, engineering support, just-in-time — margini 20-30% superiori."
    },
    "marketing": {
      "1-2": "Aggiorna il profilo aziendale su Google My Business e LinkedIn con foto del reparto produttivo, capacità e settori serviti — gratuito.",
      "2-3": "Partecipa a 1-2 fiere di settore annue (EMO, MECSPE, ~3.000-8.000€ per stand base) — fonte diretta di contatti qualificati B2B.",
      "3-4": "Attiva campagne LinkedIn Ads mirate su purchasing manager e responsabili acquisti dei settori target (~500-1.500€/mese).",
      "4-5": "Struttura un piano marketing annuo: fiere + digital + case study + certificazioni settoriali — budget dedicato 2-4% del fatturato."
    },
    "sitoweb": {
      "1-2": "Aggiorna il sito con capacità produttive reali, elenco lavorazioni, tolleranze e settori serviti — restyling base ~500-1.500€.",
      "2-3": "Aggiungi case study tecnici, video del reparto e modulo preventivo online — lead generation B2B diretta (~1.500-3.000€ una tantum).",
      "3-4": "SEO tecnico su parole chiave di settore (lavorazioni CNC, fresatura, tornitura + zona geografica) — agenzia ~500-1.000€/mese.",
      "4-5": "Sito multilingua con area clienti riservata per tracking commesse e documentazione tecnica — investimento ~8.000-15.000€."
    },
    "ecommerce": {
      "1-2": "Iscriviti a portali B2B di settore (Kompass, Europages) per aumentare la visibilità internazionale — ~200-500€/anno.",
      "2-3": "Attiva un configuratore preventivi online per lavorazioni standard — riduce il tempo di risposta e qualifica i lead (~2.000-5.000€).",
      "3-4": "Sviluppa partnership con distributori o agenti internazionali per l'export — espande il mercato senza costi fissi aggiuntivi rilevanti.",
      "4-5": "Portale clienti B2B con inserimento ordini, tracking commesse e storico documenti (~5.000-12.000€) — fidelizza i clienti principali."
    }
  },
  "manifatturiero_automotive": {
    "vendite": {
      "1-2": "Identifica 1-2 tecnici interni da formare sulla presentazione delle capacità produttive ai buyer automotive — nessun costo aggiuntivo.",
      "2-3": "Partecipa alle qualifiche fornitori dei tier-1 della tua zona con un tecnico-commerciale dedicato (~1.500-2.500€/mese) — processo lungo 3-6 mesi.",
      "3-4": "Assumi un key account manager specializzato OEM/tier-1 (~3.000-4.500€/mese) — gestisce le relazioni con i clienti strategici e le gare.",
      "4-5": "Struttura un ufficio commerciale automotive: key account + supporto tecnico-offerta + project manager (~8.000-12.000€/mese totale)."
    },
    "pipeline": {
      "1-2": "Traccia ogni RFQ (Request For Quotation) ricevuta su Excel: cliente, componente, volumi, stato e deadline — nessun costo.",
      "2-3": "Adotta un CRM con gestione RFQ e tempi di risposta garantiti (max 5 giorni lavorativi) — ~50-150€/mese.",
      "3-4": "Implementa un sistema di win/loss analysis su ogni gara persa — capire perché perdi è più utile di qualsiasi campagna marketing.",
      "4-5": "CRM integrato con APQP/PPAP e gestione campionature — obbligatorio per fornitori tier-1 strutturati (~300-600€/mese)."
    },
    "team": {
      "1-2": "Forma i tuoi tecnici sulla lettura dei disegni CATIA/UG e sulle norme automotive (IATF, PPAP) — formazione esterna ~500-2.000€.",
      "2-3": "Assumi o forma un quality engineer dedicato all'automotive (~2.500-3.500€/mese) — indispensabile per le qualifiche tier-1.",
      "3-4": "Struttura un team tecnico-commerciale: application engineer + key account manager — presidia sia la parte tecnica che quella relazionale.",
      "4-5": "Team multidisciplinare con APQP coordinator, quality manager e sales director automotive — struttura da tier-2 qualificato."
    },
    "processi": {
      "1-2": "Documenta i processi produttivi con FMEA base e piano di controllo — prerequisito per qualsiasi qualifica tier-1.",
      "2-3": "Ottieni o aggiorna la certificazione IATF 16949 (~8.000-20.000€ una tantum + ~3.000€/anno mantenimento) — obbligatoria per molti tier-1.",
      "3-4": "Implementa SPC (Statistical Process Control) sui processi critici e gestione non conformità strutturata — riduce scarti e resi.",
      "4-5": "Sistema MES integrato con tracciabilità completa di lotto, macchina e operatore — richiesto dai clienti OEM premium (~10.000-30.000€)."
    },
    "ricavi": {
      "1-2": "Calcola il costo reale per componente includendo setup, scarti e rilavorazioni — molti fornitori automotive lavorano in perdita senza saperlo.",
      "2-3": "Negozia clausole di revisione prezzi semestrali legate alle variazioni delle materie prime — protegge i margini su contratti pluriennali.",
      "3-4": "Diversifica su componenti a maggior valore aggiunto (es. da grezzo a lavorato finito, da singolo pezzo ad assemblato) — margini +15-25%.",
      "4-5": "Sviluppa engineering services: co-design, DFM (Design For Manufacturing) consulting — fatturazione a progetto con margini >40%."
    },
    "marketing": {
      "1-2": "Crea una scheda fornitori professionale con capacità produttive, macchinario, qualifiche e settori serviti — usata nelle qualifiche.",
      "2-3": "Partecipa a Automotive Dealer Day, Bologna Motor Show o fiere tier fornitori (~3.000-10.000€) — visibilità diretta con buyer.",
      "3-4": "Pubblica case study tecnici su LinkedIn e sui portali automotive (Motor1 Business, Automotive World) — credibilità settoriale.",
      "4-5": "Strategia di thought leadership: webinar tecnici, pubblicazioni su riviste di settore e partnership con centri di ricerca automotive."
    },
    "sitoweb": {
      "1-2": "Aggiorna il sito con sezione dedicata all'automotive: materiali lavorati, tolleranze, qualifiche e clienti di riferimento (se possibile).",
      "2-3": "Aggiungi una sezione qualifiche e certificazioni con documenti scaricabili — i buyer la verificano prima di qualsiasi visita.",
      "3-4": "Sito in inglese e tedesco — i buyer dei tier-1 europei (Germania, Francia) cercano fornitori in lingua locale.",
      "4-5": "Portale fornitori B2B con area riservata per accesso a disegni, specifiche e stato commesse — standard dei tier-1 strutturati."
    },
    "ecommerce": {
      "1-2": "Iscriviti a portali fornitori automotive (Automotive-agentur.de, Kompass Automotive) per aumentare la visibilità B2B internazionale.",
      "2-3": "Attiva un sistema di gestione RFQ digitale — risposta entro 48h con preventivo strutturato differenzia dai competitor artigianali.",
      "3-4": "Sviluppa accordi di fornitura pluriennale con i tier-1 principali — volumi garantiti in cambio di prezzi stabili e priorità produttiva.",
      "4-5": "EDI (Electronic Data Interchange) integrato con i sistemi degli OEM clienti — obbligatorio per i fornitori strategici (~5.000-15.000€)."
    }
  },
  "manifatturiero_packaging": {
    "vendite": {
      "1-2": "Identifica le aziende food/farmaceutico/cosmetica della tua zona e fai visite dirette con campioni fisici — nessun costo oltre al tempo.",
      "2-3": "Attiva 1-2 agenti con esperienza nel packaging industriale o nel food (~800-1.500€/mese provvigioni) — portafoglio clienti pronto.",
      "3-4": "Assumi un commerciale con background packaging (~2.500-3.500€/mese) che gestisce i key account e sviluppa nuovi mercati verticali.",
      "4-5": "Struttura una rete commerciale per verticale: food, farmaceutico, e-commerce, lusso — con key account dedicato per segmento."
    },
    "pipeline": {
      "1-2": "Traccia ogni richiesta campionatura su Excel con cliente, formato, materiale, quantità e stato approvazione.",
      "2-3": "CRM con gestione campionature e follow-up approvazione — il ciclo di vendita nel packaging è lungo, serve tracciamento rigoroso (~50€/mese).",
      "3-4": "Definisci KPI di pipeline: nr campionature attive, tasso approvazione, tempo medio approvazione — ottimizza il processo di sviluppo.",
      "4-5": "CRM integrato con gestione artwork, approvazioni grafiche e forecast ordini — indispensabile con 50+ clienti attivi."
    },
    "team": {
      "1-2": "Forma i tecnici sulla presentazione dei materiali e delle certificazioni (riciclabilità, food contact, FSC) — argomento sempre più rilevante.",
      "2-3": "Assumi o forma un grafico/pre-stampa interno (~1.500-2.500€/mese) — riduce i tempi di campionatura e migliora la qualità delle proposte.",
      "3-4": "Struttura un team sviluppo prodotto: commerciale + grafico + tecnico packaging — gestisce internamente l'intero ciclo campionatura.",
      "4-5": "Key account manager per segmento + coordinatore grafico + project manager sviluppo — struttura da fornitore premium."
    },
    "processi": {
      "1-2": "Standardizza il processo di campionatura: template briefing, checklist materiali, tempi di consegna garantiti — riduce rilavorazioni.",
      "2-3": "Certifica i materiali per il contatto alimentare (Reg. CE 1935/2004) se non già fatto (~2.000-5.000€) — apre mercati food e farmaceutico.",
      "3-4": "Implementa un sistema di gestione artwork digitale — approvazioni online con cliente, versioning e archivio ~100-200€/mese.",
      "4-5": "ISO 9001 + certificazioni sostenibilità (FSC, PEFC, riciclabilità) — prerequisito per GDO e brand premium internazionali."
    },
    "ricavi": {
      "1-2": "Rivedi il pricing includendo i costi reali di setup stampa, clichè e cambio colori — spesso sottostimati nelle tirature basse.",
      "2-3": "Proponi contratti annuali con volumi minimi garantiti in cambio di prezzi bloccati — protegge dai picchi materie prime.",
      "3-4": "Sviluppa la linea sustainable packaging (materiali riciclati, biobased) — margini +20-30% rispetto al packaging tradizionale.",
      "4-5": "Servizi di packaging design e consulenza normativa — fatturazione a progetto con margini >40%."
    },
    "marketing": {
      "1-2": "Crea un portfolio fisico e digitale con campioni per settore (food, farmaceutico, e-commerce) — strumento base di vendita.",
      "2-3": "Partecipa a Packaging Première, Ipack-Ima o Luxe Pack (~3.000-8.000€) — fiere verticali per il packaging premium.",
      "3-4": "Content marketing su LinkedIn con focus sostenibilità e innovazione materiali — tema molto rilevante per i buyer packaging.",
      "4-5": "Strategia di brand positioning come packaging partner (non solo fornitore) — case study, premi di settore, presenza stampa."
    },
    "sitoweb": {
      "1-2": "Aggiorna il sito con galleria campioni per settore e materiali, con specifiche tecniche scaricabili.",
      "2-3": "Aggiungi configuratore packaging base (formato, materiale, stampa, quantità minima) — lead generation qualificata.",
      "3-4": "Sezione sostenibilità con certificazioni, materiali e impatto ambientale — sempre più richiesta dai brand.",
      "4-5": "Portale cliente per gestione ordini, stato spedizioni e archivio artwork — fidelizza i clienti principali."
    },
    "ecommerce": {
      "1-2": "Iscriviti a portali packaging B2B (Packagingconnections, Europages) per visibilità internazionale.",
      "2-3": "Attiva un preventivatore online per packaging standard — riduce il tempo di risposta e qualifica i lead.",
      "3-4": "Sviluppa una linea packaging e-commerce (scatole, buste, nastri) con ordini online per tirature medio-basse.",
      "4-5": "Piattaforma B2B con riordino automatico, gestione stock packaging cliente e integrazione ERP — fidelizza i grandi account."
    }
  },
  "manifatturiero_cterzi": {
    "vendite": {
      "1-2": "Identifica 3-5 aziende nella tua zona che potrebbero esternalizzare le lavorazioni che fai — visita diretta con campioni.",
      "2-3": "Specializzati su una lavorazione o materiale specifico e diventa il riferimento di zona — agente con portafoglio clienti industriali (~800€/mese provvigioni).",
      "3-4": "Assumi un tecnico-commerciale (~2.500-3.500€/mese) che presidia i clienti esistenti e sviluppa nuove partnership conto terzi.",
      "4-5": "Struttura accordi di fornitura esclusiva con 3-5 clienti strategici — volumi garantiti, prezzi stabili, crescita prevedibile."
    },
    "pipeline": {
      "1-2": "Traccia ogni richiesta di lavorazione: cliente, specifica, quantità, tempi, stato offerta — Excel base.",
      "2-3": "CRM semplice per gestire le offerte attive e i follow-up — nel conto terzi il cliente va seguito o va dal concorrente (~30-50€/mese).",
      "3-4": "Monitora il tasso di rinnovo ordini e il fatturato per cliente — identifica chi sta riducendo i volumi prima che sia tardi.",
      "4-5": "CRM integrato con pianificazione produzione — il cliente vuole sapere in tempo reale lo stato delle sue lavorazioni."
    },
    "team": {
      "1-2": "Forma i tuoi operatori sulla comunicazione con il cliente: tempi di consegna realistici, gestione urgenze, qualità garantita.",
      "2-3": "Assegna un referente tecnico fisso per ogni cliente principale — la continuità relazionale è il principale fattore di fidelizzazione.",
      "3-4": "Struttura turni o straordinari per gestire i picchi produttivi senza perdere ordini urgenti — la reattività è il tuo vantaggio competitivo.",
      "4-5": "Team di coordinamento produzione-commerciale: pianificatore + referente clienti + quality control dedicato."
    },
    "processi": {
      "1-2": "Standardizza la gestione delle urgenze: procedura chiara su come gestire ordini last minute senza bloccare la produzione ordinaria.",
      "2-3": "Implementa un sistema di controllo qualità documentato con report per ogni lotto — riduce i resi e aumenta la fiducia del cliente.",
      "3-4": "MRP (Material Requirements Planning) base per ottimizzare gli acquisti di materie prime in base agli ordini confermati (~200-500€/mese).",
      "4-5": "Certificazione ISO 9001 + sistema MES per tracciabilità completa — prerequisito per clienti strutturati e supply chain internazionali."
    },
    "ricavi": {
      "1-2": "Calcola il costo reale di ogni lavorazione: ore macchina + setup + manodopera + overhead — molti conto terzi lavorano in perdita.",
      "2-3": "Inserisci supplementi per urgenze, piccole serie e materiali fuori standard — il costo reale deve essere coperto.",
      "3-4": "Proponi servizi complementari: magazzinaggio, kitting, consegna just-in-time — aumenta il fatturato per cliente senza nuove macchine.",
      "4-5": "Sviluppa accordi di partnership industriale con i clienti principali — co-investimento in attrezzature, volumi garantiti, crescita condivisa."
    },
    "marketing": {
      "1-2": "Aggiorna Google My Business e LinkedIn con foto del reparto, macchinario disponibile e lavorazioni specifiche.",
      "2-3": "Iscriviti a portali fornitori B2B (Kompass, IndustrySearch) — i buyer industriali cercano attivamente subfornitori online.",
      "3-4": "Partecipa a BI-MU, Lamiera o fiere di settore specifiche (~2.000-6.000€) — contatti diretti con responsabili acquisti.",
      "4-5": "Certificazioni settoriali e partnership con associazioni di categoria (UCIMU, Federmeccanica) — credibilità e visibilità."
    },
    "sitoweb": {
      "1-2": "Sito aggiornato con elenco lavorazioni, macchinario disponibile, capacità produttiva e settori serviti.",
      "2-3": "Aggiungi modulo richiesta preventivo con upload disegno tecnico — riduce le barriere per i nuovi clienti.",
      "3-4": "Video del reparto produttivo e gallery lavorazioni eseguite — il cliente vuole vedere prima di affidarti un ordine.",
      "4-5": "Area clienti con tracking ordini, documenti di qualità e storico lavorazioni — standard per i fornitori strutturati."
    },
    "ecommerce": {
      "1-2": "Iscriviti a Xometry o Protolabs Network per ricevere richieste di preventivo da clienti che non conosci ancora.",
      "2-3": "Attiva un preventivatore online per lavorazioni standard (tornitura, fresatura, taglio laser) — lead qualificati 24/7.",
      "3-4": "Sviluppa accordi con broker industriali o agenti multi-settore per ampliare il bacino clienti senza aumentare i costi fissi.",
      "4-5": "Piattaforma B2B per inserimento ordini ricorrenti, tracciamento stato lavorazione e accesso documentazione qualità."
    }
  },
  "manifatturiero_elettromeccanica": {
    "vendite": {
      "1-2": "Identifica 1-2 tecnici interni con buone capacità relazionali da formare come tecnico-commerciali — nessun costo aggiuntivo.",
      "2-3": "Attiva un tecnico-commerciale interno o un agente con background ingegneristico (~1.500-2.500€/mese) — conosce il prodotto e parla con i tecnici del cliente.",
      "3-4": "Assumi un sales engineer dedicato (~3.000-4.500€/mese) con portafoglio clienti industriali e obiettivi mensili strutturati.",
      "4-5": "Struttura un team commerciale tecnico: sales engineer + application specialist + key account — presidio completo del cliente."
    },
    "pipeline": {
      "1-2": "Traccia ogni richiesta tecnica su Excel: cliente, applicazione, specifiche, budget stimato, stato — base indispensabile.",
      "2-3": "CRM con gestione offerte tecniche e follow-up strutturato — nel B2B elettromeccanico il ciclo è lungo, serve persistenza (~50-100€/mese).",
      "3-4": "Gestisci le offerte con prioritizzazione: valore atteso, probabilità di chiusura, risorse necessarie — focus sui deal a maggior valore.",
      "4-5": "CRM integrato con supporto tecnico pre-vendita, gestione campioni e laboratorio prove — pipeline tecnica strutturata."
    },
    "team": {
      "1-2": "Forma i tecnici sulla presentazione dei prodotti e delle applicazioni — il cliente vuole parlare con chi capisce il suo problema.",
      "2-3": "Struttura un sistema di incentivi per i tecnici che generano opportunità commerciali — chi installa vede i problemi prima del commerciale.",
      "3-4": "Assumi un application engineer (~2.500-3.500€/mese) dedicato al supporto tecnico pre-vendita e alla gestione dei prototipi.",
      "4-5": "Team tecnico-commerciale multidisciplinare con formazione continua su nuove tecnologie e normative di settore."
    },
    "processi": {
      "1-2": "Standardizza le schede tecniche prodotto con curve di prestazione, dati di installazione e normative di riferimento.",
      "2-3": "Implementa un processo di gestione dei campioni e dei prototipi — traccia dove sono, con chi e qual è lo stato della valutazione.",
      "3-4": "Certificazioni CE, ATEX o specifiche di settore richieste dai clienti principali (~3.000-15.000€ per certificazione).",
      "4-5": "Sistema di gestione tecnica integrata: CAD/CAM, BOM (Bill of Materials), gestione revisioni e configuratore prodotto."
    },
    "ricavi": {
      "1-2": "Rivedi il pricing dei ricambi e dei servizi di assistenza — spesso sottovalutati rispetto al valore che portano al cliente.",
      "2-3": "Proponi contratti di manutenzione preventiva ai clienti principali — ricavo ricorrente prevedibile con margini >40%.",
      "3-4": "Sviluppa una linea di prodotti customizzati ad alto margine — il cliente paga la specificità, non solo il componente.",
      "4-5": "Servizi di engineering: consulenza applicativa, retrofitting, integrazione sistemi — fatturazione a progetto con margini elevati."
    },
    "marketing": {
      "1-2": "Aggiorna il sito e LinkedIn con applicazioni reali del tuo prodotto: settore, problema risolto, risultato ottenuto.",
      "2-3": "Partecipa a SPS Italia, Hannover Messe o fiere verticali di settore (~4.000-10.000€) — contatti diretti con ingegneri e buyer.",
      "3-4": "Content marketing tecnico: white paper, video applicativi, webinar — posizionamento come partner tecnico non come semplice fornitore.",
      "4-5": "Strategia di account based marketing sui clienti target: contenuto personalizzato, eventi dedicati, visite in stabilimento."
    },
    "sitoweb": {
      "1-2": "Sito con catalogo prodotti tecnico, schede PDF scaricabili e form richiesta campione o preventivo.",
      "2-3": "Aggiungi sezione applicazioni con case study reali: settore, problema, soluzione, risultato misurabile.",
      "3-4": "Configuratore prodotto online per prodotti customizzabili — lead qualificati e risparmio di tempo del tecnico-commerciale.",
      "4-5": "Portale partner/distributori con accesso a documentazione tecnica, listini e supporto pre-vendita online."
    },
    "ecommerce": {
      "1-2": "Iscriviti a portali tecnici B2B (GlobalSpec, Thomasnet, Kompass) per aumentare la visibilità internazionale.",
      "2-3": "Attiva un e-commerce B2B per ricambi standard e prodotti a catalogo — ordini ripetitivi automatizzati senza impegno commerciale.",
      "3-4": "Sviluppa una rete di distributori tecnici per coprire zone geografiche non presidiate dal commerciale interno.",
      "4-5": "Piattaforma digitale integrata con ERP del cliente per riordino automatico ricambi critici — lock-in strategico del cliente."
    }
  },
  "manifatturiero_tessile_tessuti": {
    "vendite": {
      "1-2": "Identifica 3-5 brand o laboratori sartoriali della tua zona che potrebbero usare i tuoi tessuti — visita diretta con campionario.",
      "2-3": "Attiva 1-2 agenti plurimandatari con portafoglio clienti nel fashion e nel tessile contract (~800-1.500€/mese provvigioni).",
      "3-4": "Assumi un commerciale con esperienza moda/tessile (~2.500-3.500€/mese) per presidiare i clienti strategici e sviluppare l'export.",
      "4-5": "Struttura una rete agenti per area geografica + key account per i brand principali + ufficio stile per le collezioni."
    },
    "pipeline": {
      "1-2": "Traccia ogni richiesta campionatura: cliente, articolo, quantità, stagione, stato approvazione — ciclo moda è stagionale.",
      "2-3": "CRM con gestione campagne campionario per stagione (PE/AI) e follow-up strutturato (~30-80€/mese).",
      "3-4": "Monitora il tasso di conferma ordini per stagione e per cliente — identifica i clienti che campionano ma non ordinano.",
      "4-5": "CRM integrato con gestione stock campionario, previsioni ordini per stagione e pianificazione produzione."
    },
    "team": {
      "1-2": "Forma chi gestisce il campionario sulla presentazione degli articoli: composizione, certificazioni, minimi d'ordine, tempi.",
      "2-3": "Assumi o forma un agente/showroom manager per la gestione delle campagne — il campionario non si vende da solo.",
      "3-4": "Struttura un ufficio sviluppo prodotto: stilista/colorista + responsabile tecnico — anticipare le tendenze è fondamentale.",
      "4-5": "Team completo: commerciale + sviluppo prodotto + logistica campionario — struttura da tessitore medio strutturato."
    },
    "processi": {
      "1-2": "Standardizza il processo di campionatura: tempi di consegna garantiti, formato schede articolo, condizioni commerciali.",
      "2-3": "Certifica le composizioni e le certificazioni richieste dal mercato: OEKO-TEX, GOTS, riciclato GRS (~1.000-5.000€).",
      "3-4": "Implementa un sistema di gestione articoli e colorimetria digitale — riduce gli errori di produzione e accelera le approvazioni.",
      "4-5": "PLM (Product Lifecycle Management) per la gestione delle collezioni — dal concept alla produzione in un unico sistema."
    },
    "ricavi": {
      "1-2": "Rivedi il pricing includendo i costi reali di orditura, tessitura e finissaggio — molte PMI tessili sottostimano i costi di trasformazione.",
      "2-3": "Proponi articoli di nicchia ad alto valore aggiunto: tessuti tecnici, sostenibili, certificati — margini 30-50% superiori al commodity.",
      "3-4": "Sviluppa private label per brand che vogliono un tessuto esclusivo — esclusività territoriale o di collezione a prezzi premium.",
      "4-5": "Servizi di consulenza tessile: sourcing, sviluppo articolo su misura, certificazioni — fatturazione a progetto."
    },
    "marketing": {
      "1-2": "Partecipa a Première Vision, Milano Unica o Texworld (~3.000-8.000€ per stand base) — le fiere sono il canale principale nel tessile.",
      "2-3": "Showroom fisso a Milano o Firenze (~1.000-2.000€/mese) o partecipazione a showroom collettivi — presidio nei distretti moda.",
      "3-4": "Digital marketing su LinkedIn e Instagram con focus sulla qualità dei materiali e sulle certificazioni sostenibili.",
      "4-5": "Strategia di brand building: presenza stampa specializzata (Vogue Fabrics, Textile Network), partnership con designer."
    },
    "sitoweb": {
      "1-2": "Sito con catalogo articoli stagionale, composizioni, certificazioni e form richiesta campionatura.",
      "2-3": "Showroom digitale con foto ad alta risoluzione dei tessuti e richiesta campioni online — lead generation B2B.",
      "3-4": "Sito multilingua (inglese, francese) con area riservata per agenti e clienti fidelizzati.",
      "4-5": "Piattaforma digitale con configuratore colori, gestione campionature online e accesso a schede tecniche per gli ufficio stile."
    },
    "ecommerce": {
      "1-2": "Iscriviti a portali tessili B2B (Texintel, Sourceit) per visibilità internazionale senza investimenti fisici.",
      "2-3": "E-commerce B2B per ordini ripetitivi di articoli a catalogo — riduce il carico amministrativo sugli ordini piccoli.",
      "3-4": "Sviluppa canali di vendita diretti B2C per tessuti al taglio (sartorie, hobbisti, piccoli brand) — mercato in forte crescita.",
      "4-5": "Piattaforma digitale integrata con i sistemi degli ufficio stile clienti principali — sviluppo articoli in collaborazione remota."
    }
  },
  "manifatturiero_tessile_capi": {
    "vendite": {
      "1-2": "Identifica brand locali o retailer che potrebbero esternalizzare la produzione — visita con campioni della tua qualità produttiva.",
      "2-3": "Attiva un agente con portafoglio brand nel tuo segmento (casual, sportswear, lusso) — sa come entrare nei buyer dei brand (~800-1.500€/mese).",
      "3-4": "Assumi un commercial manager (~2.500-3.500€/mese) con esperienza production house — gestisce i brand clienti e sviluppa nuovi mercati.",
      "4-5": "Struttura un ufficio commerciale: commercial manager + sourcing specialist + export manager — struttura da production house strutturata."
    },
    "pipeline": {
      "1-2": "Traccia ogni richiesta di campionatura e quotazione: brand, articolo, quantità, stagione, stato — ciclo moda è rigidamente stagionale.",
      "2-3": "CRM per gestire le campagne di sviluppo campioni per stagione con follow-up strutturato sui buyer (~30-80€/mese).",
      "3-4": "Monitora il conversion rate campione→ordine per brand e per stagione — capire dove perdi è fondamentale.",
      "4-5": "PLM integrato con CRM — gestione completa dal brief di sviluppo all'ordine di produzione."
    },
    "team": {
      "1-2": "Forma il responsabile produzione sulla comunicazione con i buyer: tempi, campioni, modifiche, qualità — è il tuo primo commerciale.",
      "2-3": "Assumi un merchandiser o product developer (~1.800-2.500€/mese) che gestisce lo sviluppo campioni con i brand clienti.",
      "3-4": "Struttura un team sviluppo: pattern maker + campionarista + QC — velocità e qualità nello sviluppo sono il tuo vantaggio competitivo.",
      "4-5": "Team completo: commercial + sviluppo prodotto + QC + pianificazione produzione — struttura da production house qualificata."
    },
    "processi": {
      "1-2": "Standardizza i processi di campionatura: tempi garantiti, format scheda tecnica, procedura di revisione e approvazione.",
      "2-3": "Implementa un sistema di controllo qualità documentato con AQL (Acceptable Quality Level) — prerequisito per i brand strutturati.",
      "3-4": "Certificazioni SA8000 o BSCI per i brand che richiedono audit sociali (~3.000-8.000€) — sempre più richieste dai brand europei.",
      "4-5": "Sistema PLM per la gestione completa delle specifiche tecniche, revisioni e approvazioni — standard dei production house qualificati."
    },
    "ricavi": {
      "1-2": "Rivedi il pricing dei campioni — il costo di sviluppo deve essere coperto, non regalato nella speranza dell'ordine.",
      "2-3": "Proponi servizi di sviluppo completo (tessuto + modello + campione) invece della sola confezione — margini superiori.",
      "3-4": "Sviluppa una linea di produzione small batch per brand emergenti — volumi piccoli ma margini più alti e relazioni a lungo termine.",
      "4-5": "Full-package production: dall'acquisto del tessuto alla logistica finale — margini superiori alla sola confezione conto terzi."
    },
    "marketing": {
      "1-2": "Partecipa a White Milano, Pitti Uomo o fiere production house (~2.000-6.000€) — i buyer cercano attivamente nuovi produttori.",
      "2-3": "Showroom produzione con sala prove e campionario permanente — i brand vogliono vedere l'ambiente prima di affidarti un ordine.",
      "3-4": "Portfolio digitale con foto dei capi prodotti, dettagli costruttivi e certificazioni — strumento fondamentale nelle trattative.",
      "4-5": "Strategia di posizionamento come production house di qualità: press release, presenza su platform B2B moda, referenze brand."
    },
    "sitoweb": {
      "1-2": "Sito con portfolio capi prodotti, capacità produttive, certificazioni e form contatto per i buyer.",
      "2-3": "Aggiungi sezione specializzazioni (tessuti tecnici, sostenibili, lavorazioni particolari) e caso studio recenti.",
      "3-4": "Sito in inglese con area riservata per brand clienti — accesso a schede tecniche, stato ordini e documentazione qualità.",
      "4-5": "Piattaforma digitale per sviluppo campioni remoto: upload specifiche, revisioni online, approvazione digitale."
    },
    "ecommerce": {
      "1-2": "Iscriviti a Maker's Row, Common Objective o portali production house per visibilità con brand internazionali.",
      "2-3": "Sviluppa un servizio di produzione on-demand per piccole serie (50-200 pezzi) — mercato in forte crescita con i brand DTC.",
      "3-4": "Piattaforma B2B per riordini e gestione ordini ricorrenti con i brand clienti — automatizza la parte amministrativa.",
      "4-5": "Integrazione digitale completa con i sistemi dei brand principali — sviluppo campioni remoto, approvazioni online, tracking produzione."
    }
  },
  "servizi_it": {
    "vendite": {
  ...
  "edilizia_residenziale": {
    "vendite": {
      "1-2": "Metti un cartello professionale sui cantieri aperti con foto, contatti e QR code — e chiedi referenze attive ai clienti soddisfatti. Costo: ~200-500€ stampa materiali.",
      "2-3": "Costruisci una rete di segnalatori: geometri, architetti, studi tecnici della zona. Accordo di segnalazione formale con provvigione (3-5% sul contratto) — operativo in 1-2 mesi.",
      "3-4": "Attiva un procacciatore o agente part-time per sviluppare i contatti con sviluppatori immobiliari e amministratori di condominio (~1.000-1.800€/mese) — operativo in 2 mesi.",
      "4-5": "Struttura commerciale con responsabile sviluppo clienti (~2.500-3.500€/mese) + rete segnalatori attiva + presenza portali immobiliari — operativa in 4-6 mesi."
    },
    "pipeline": {
      "1-2": "Tieni un registro trattative su Excel: cliente, tipo lavoro, valore stimato, stato, prossimo step — nessun costo, operativo subito.",
      "2-3": "Adotta un CRM base (Pipedrive o simile, ~30-50€/mese) per tracciare preventivi, follow-up e storico cliente — operativo in 1-2 settimane.",
      "3-4": "Definisci tempi massimi di risposta preventivi (max 48h) e monitora il tasso di chiusura mensile — nessun costo aggiuntivo, richiede disciplina.",
      "4-5": "CRM integrato con gestione cantieri, SAL (Stato Avanzamento Lavori) e fatturazione (~150-300€/mese) — operativo in 2-3 mesi."
    },
    "team": {
      "1-2": "Forma i tuoi capi cantiere sulla comunicazione con il cliente: aggiornamenti proattivi, gestione delle varianti, soddisfazione finale — nessun costo.",
      "2-3": "Struttura un sistema di incentivi per i capi cantiere che portano referenze o segnalazioni — provvigione sul contratto acquisito.",
      "3-4": "Assumi un coordinatore tecnico-commerciale (~2.000-3.000€/mese) che gestisce i preventivi e mantiene i rapporti con professionisti e clienti.",
      "4-5": "Team strutturato: responsabile commerciale + coordinatore cantieri + back office preventivi — struttura da impresa edile media."
    },
    "processi": {
      "1-2": "Standardizza il formato dei preventivi: copertina professionale, computo metrico chiaro, tempi di esecuzione garantiti e condizioni di pagamento — nessun costo.",
      "2-3": "Implementa un processo di gestione delle varianti in corso d'opera: ogni modifica documentata, firmata e preventivata prima di essere eseguita.",
      "3-4": "Software gestione cantieri (PriMus, Acca Software, ~100-300€/mese) per computi metrici, SAL e documentazione — operativo in 1 mese.",
      "4-5": "Sistema integrato gestione cantieri + CRM + fatturazione — tracciabilità completa da preventivo a saldo finale."
    },
    "ricavi": {
      "1-2": "Rivedi il pricing: calcola il costo reale per ogni lavorazione includendo manodopera, materiali, noli e overhead — molte imprese edili sottostimano.",
      "2-3": "Proponi sistematicamente servizi complementari: smaltimento macerie, arredi fissi, impianti — aumenta il valore del contratto del 15-30%.",
      "3-4": "Sviluppa contratti di manutenzione post-lavoro per condomini e abitazioni — ricavo ricorrente prevedibile con margini >35%.",
      "4-5": "Posizionamento chiavi in mano: progetto + costruzione + pratiche burocratiche — margini superiori alla sola esecuzione."
    },
    "marketing": {
      "1-2": "Profilo Google My Business ottimizzato con foto dei cantieri completati, recensioni e risposta attiva — gratuito, operativo in 1 settimana.",
      "2-3": "Pagina Facebook/Instagram con before/after dei cantieri completati (~300-600€/mese per gestione social) — lead locali diretti.",
      "3-4": "Campagne Google Ads locali su parole chiave ristrutturazione + zona (~500-1.500€/mese) — lead qualificati per interventi medio-grandi.",
      "4-5": "Strategia marketing integrata: social + SEO locale + presenza portali (Habitissimo, Houzz) + referral program strutturato."
    },
    "sitoweb": {
      "1-2": "Sito base con portfolio lavori realizzati, servizi offerti, zona di intervento e form contatto — ~800-2.000€ una tantum.",
      "2-3": "Sito aggiornato con gallery before/after, testimonianze clienti e richiesta preventivo online — lead generation diretta.",
      "3-4": "SEO locale su parole chiave ristrutturazione + comune/zona (~400-800€/mese agenzia) — visibilità organica a lungo termine.",
      "4-5": "Sito professionale con configuratore preventivo base, area clienti per tracking cantiere e blog tecnico per SEO."
    },
    "ecommerce": {
      "1-2": "Iscriviti a Habitissimo, Prontopro o portali simili (~50-150€/mese) — lead qualificati da privati che cercano imprese.",
      "2-3": "Sviluppa partnership con showroom materiali, rivenditori ceramiche e falegnamerie — referenze incrociate senza costi fissi.",
      "3-4": "Accordi con studi di architettura e progettazione per essere inserito nella loro lista fornitori consigliati.",
      "4-5": "Piattaforma digitale per preventivi online e gestione cantieri da remoto — differenziazione rispetto alle imprese tradizionali."
    }
  },
  "edilizia_impianti": {
    "vendite": {
      "1-2": "Contatta attivamente le imprese edili della zona per essere inserito come subappaltatore fisso per impianti — nessun costo, operativo subito.",
      "2-3": "Attiva un agente o procacciatore con portafoglio contatti in studi tecnici e imprese edili (~800-1.500€/mese provvigioni) — operativo in 1-2 mesi.",
      "3-4": "Assumi un tecnico-commerciale (~2.500-3.500€/mese) che presidia imprese edili, studi tecnici e developer immobiliari.",
      "4-5": "Struttura commerciale con responsabile sviluppo + rete agenti per territorio + key account per i developer principali."
    },
    "pipeline": {
      "1-2": "Traccia ogni preventivo: cliente, tipo impianto, valore, stato, scadenza — Excel base, nessun costo.",
      "2-3": "CRM semplice per gestire i preventivi aperti e i follow-up — nel settore impiantistico il cliente dimentica se non lo segui (~30-50€/mese).",
      "3-4": "Monitora il tasso di chiusura per tipo di impianto e per canale — identifica dove conviene investire tempo commerciale.",
      "4-5": "CRM integrato con gestione commesse, pianificazione squadre e SAL — visibilità completa dal preventivo alla fattura finale."
    },
    "team": {
      "1-2": "Forma i tuoi installatori sulla comunicazione con il cliente durante i lavori — aggiornamenti proattivi e gestione pulita del cantiere.",
      "2-3": "Struttura incentivi per il team che segnala opportunità di lavoro aggiuntivo o nuovi clienti — provvigione sulla commessa acquisita.",
      "3-4": "Assumi un coordinatore tecnico-commerciale (~2.000-3.000€/mese) che gestisce preventivi e mantiene i rapporti con imprese e studi.",
      "4-5": "Team strutturato: commerciale + coordinatore tecnico + back office — gestisce preventivi, commesse e relazioni clienti."
    },
    "processi": {
      "1-2": "Standardizza i preventivi con schema fisso: tipologia impianto, materiali specificati, tempi esecuzione e condizioni di garanzia.",
      "2-3": "Implementa la dichiarazione di conformità (ex legge 46/90, ora DM 37/08) come processo sistematico — obbligatoria per tutti gli impianti.",
      "3-4": "Software gestione commesse impiantistiche (~100-250€/mese) per pianificazione squadre, ordini materiali e SAL.",
      "4-5": "Sistema integrato: gestione commesse + magazzino materiali + fatturazione + CRM — visibilità completa sull'azienda."
    },
    "ricavi": {
      "1-2": "Rivedi il pricing includendo tutti i costi: trasferte, smaltimento materiali, certificazioni e tempo per pratiche burocratiche.",
      "2-3": "Proponi contratti di manutenzione annuale su impianti installati (~200-800€/anno per impianto) — ricavo ricorrente prevedibile.",
      "3-4": "Sviluppa la divisione manutenzione e pronto intervento — margini più alti rispetto al solo installazione e clientela fidelizzata.",
      "4-5": "Posizionamento come partner energetico: diagnosi energetica + efficientamento + manutenzione — valore aggiunto superiore."
    },
    "marketing": {
      "1-2": "Google My Business ottimizzato con foto degli impianti installati e certificazioni — gratuito, genera lead locali qualificati.",
      "2-3": "Campagne Google Ads locali su parole chiave impianti + zona (~400-1.000€/mese) — lead diretti per installazioni e manutenzioni.",
      "3-4": "Partnership con rivenditori materiali e showroom bagno/cucina per referenze reciproche — costo zero, lead qualificati.",
      "4-5": "Presenza su portali impiantistica (CNA, Confartigianato) + certificazioni energetiche per posizionamento premium."
    },
    "sitoweb": {
      "1-2": "Sito base con servizi, zone di intervento, certificazioni e contatti — ~800-1.500€ una tantum.",
      "2-3": "Aggiungi gallery lavori realizzati, certificazioni scaricabili e preventivo online — lead generation diretta.",
      "3-4": "SEO locale per impianti + zona (~300-700€/mese) — visibilità organica per le ricerche locali più frequenti.",
      "4-5": "Sito con area clienti per accesso a dichiarazioni di conformità, manuali e storico interventi — fidelizzazione."
    },
    "ecommerce": {
      "1-2": "Iscriviti a Prontopro, Habitissimo (~50-150€/mese) — lead qualificati da privati che cercano impiantisti.",
      "2-3": "Sviluppa accordi con grossisti materiali per accesso a prezzi riservati e materiali in pronto — riduce i costi e migliora i margini.",
      "3-4": "Contratti di manutenzione in abbonamento digitale — il cliente si abbona online, pagamento automatico mensile.",
      "4-5": "Piattaforma per richiesta pronto intervento e preventivi online — differenziazione digitale nel settore impiantistico."
    }
  },
  "edilizia_serramenti": {
    "vendite": {
      "1-2": "Chiedi referenze attive ai clienti soddisfatti e metti cartelli cantiere nei lavori in corso — nessun costo, genera il 30-50% dei nuovi contatti.",
      "2-3": "Attiva un agente con portafoglio contatti in studi tecnici, imprese edili e showroom (~800-1.500€/mese provvigioni) — operativo in 1-2 mesi.",
      "3-4": "Assumi un commerciale interno (~2.500-3.500€/mese) con portafoglio clienti assegnato — gestisce trattative e preventivi in autonomia.",
      "4-5": "Struttura commerciale: responsabile vendite + agenti di zona + key account per developer e studi di architettura."
    },
    "pipeline": {
      "1-2": "Traccia ogni richiesta preventivo: cliente, tipologia serramento, valore stimato, stato — Excel base, nessun costo.",
      "2-3": "CRM semplice per gestire i preventivi con follow-up sistematico — nel settore serramenti il cliente confronta 3-5 preventivi, il follow-up è decisivo (~30-50€/mese).",
      "3-4": "Monitora il tasso di chiusura per tipologia (PVC, alluminio, legno) e per canale — ottimizza dove investi il tempo commerciale.",
      "4-5": "CRM integrato con configuratore prezzi, gestione misurazioni e SAL installazioni — visibilità completa dalla trattativa alla consegna."
    },
    "team": {
      "1-2": "Forma i posatori sulla comunicazione con il cliente: aggiornamenti sui tempi, gestione pulita del cantiere, segnalazione di problemi.",
      "2-3": "Struttura incentivi per chi porta referenze o segnalazioni — provvigione sul contratto acquisito grazie alla segnalazione.",
      "3-4": "Assumi un coordinatore tecnico-commerciale (~2.000-3.000€/mese) che gestisce preventivi, misurazioni e relazioni clienti.",
      "4-5": "Team strutturato: commerciale + tecnico misurazioni + coordinatore installazioni + back office ordini fornitori."
    },
    "processi": {
      "1-2": "Standardizza il processo di preventivazione: sopralluogo, misurazione, configurazione prodotto, offerta firmata — tempi garantiti max 48h.",
      "2-3": "Software preventivazione serramenti (Domus, WinSer, ~100-300€/mese) — velocizza la produzione preventivi e riduce gli errori di misura.",
      "3-4": "Processo di gestione varianti e modifiche in corso d'ordine — ogni modifica documentata e approvata dal cliente prima dell'ordine.",
      "4-5": "Sistema integrato: configuratore + CRM + gestione ordini fornitori + pianificazione installazioni — controllo completo della commessa."
    },
    "ricavi": {
      "1-2": "Proponi sistematicamente il pacchetto completo: serramento + posa + smontaggio vecchio + smaltimento — aumenta il valore del contratto del 20-30%.",
      "2-3": "Attiva la vendita di accessori: zanzariere, veneziane integrate, sistemi oscuranti — upsell immediato con margini elevati.",
      "3-4": "Sviluppa contratti di manutenzione periodica su serramenti installati — ricavo ricorrente e fidelizzazione del cliente.",
      "4-5": "Posizionamento premium: consulenza energetica + serramenti ad alta performance + certificazione installazione — margini +25-40%."
    },
    "marketing": {
      "1-2": "Google My Business con foto dei lavori realizzati e recensioni — gratuito, genera il 40-60% dei lead locali per le PMI di serramenti.",
      "2-3": "Showroom fisico aggiornato con campioni esposti e area consulenza (~500-1.500€/mese di gestione) — converte le visite in contratti.",
      "3-4": "Campagne Google Ads locali su serramenti + zona (~400-1.200€/mese) + social con before/after installazioni.",
      "4-5": "Presenza su Houzz, Architonic e portali architettura per raggiungere studi tecnici e developer immobiliari."
    },
    "sitoweb": {
      "1-2": "Sito base con prodotti, zone di intervento, gallery lavori e richiesta preventivo — ~1.000-2.500€ una tantum.",
      "2-3": "Configuratore online base (tipo serramento, materiale, colore) con richiesta preventivo — lead qualificati direttamente.",
      "3-4": "SEO locale serramenti + zona (~400-900€/mese) + blog tecnico su efficienza energetica e bonus fiscali.",
      "4-5": "Sito con configuratore avanzato, visualizzazione 3D e area clienti per tracking ordine e installazione."
    },
    "ecommerce": {
      "1-2": "Iscriviti a Habitissimo, Prontopro (~50-150€/mese) — lead qualificati da privati in fase di ristrutturazione.",
      "2-3": "Sviluppa partnership con imprese edili e ristrutturatori per essere il loro fornitore fisso di serramenti — accordo commerciale reciproco.",
      "3-4": "Accordi con produttori premium per essere rivenditore esclusivo di zona — differenziazione di prodotto e margini protetti.",
      "4-5": "E-commerce B2C per accessori e piccoli serramenti standard + portale B2B per imprese edili — doppio canale di vendita."
    }
  },
  "commercio_distribuzione_industriale": {
    "vendite": {
      "1-2": "Mappa i 20 clienti con maggior potenziale inespresso nel tuo portafoglio e fai visite sistematiche ogni 2 settimane — nessun costo.",
      "2-3": "Attiva 1-2 agenti plurimandatari con portafoglio clienti industriali della zona (~provvigione 5-8% sul fatturato generato) — operativo in 1 mese.",
      "3-4": "Assumi un key account manager (~2.500-3.500€/mese) dedicato ai clienti strategici — gestisce trattative, offerte e sviluppo account.",
      "4-5": "Struttura commerciale per segmento: key account per i grandi + agenti di zona per i medi + inside sales per i piccoli."
    },
    "pipeline": {
      "1-2": "Traccia le trattative aperte su Excel: cliente, prodotto, valore, stato e data follow-up — nessun costo.",
      "2-3": "CRM semplice per gestire il portafoglio clienti con alert per riordini e follow-up (~30-80€/mese) — operativo in 1 settimana.",
      "3-4": "Definisci cicli di visita per categoria cliente (A ogni 2 settimane, B mensile, C trimestrale) — ottimizza il tempo commerciale.",
      "4-5": "CRM integrato con ERP per accesso real-time a stock, prezzi e storico ordini durante la visita cliente."
    },
    "team": {
      "1-2": "Forma gli agenti/commerciali sui prodotti tecnici e le applicazioni — chi vende deve sapere cosa vende più del cliente.",
      "2-3": "Struttura un piano provvigionale con bonus sul recupero clienti dormienti e sull'acquisizione di nuovi account.",
      "3-4": "Affianca un inside sales agli agenti di campo (~1.500-2.000€/mese) — gestisce ordini piccoli e libera il commerciale per i clienti strategici.",
      "4-5": "Sales manager che coordina la rete commerciale, monitora i KPI e gestisce i clienti più importanti."
    },
    "processi": {
      "1-2": "Standardizza il processo di offerta: tempi di risposta garantiti (max 24h per richieste standard), formato professionale, condizioni chiare.",
      "2-3": "Implementa un sistema di gestione degli ordini urgenti — il cliente industriale non aspetta, la reattività è il tuo principale vantaggio.",
      "3-4": "ERP o gestionale (~200-500€/mese) per controllo stock, ordini automatici ai fornitori e gestione back order.",
      "4-5": "Integrazione EDI con i clienti principali per ordini automatici — riduce l'errore umano e fidelizza il cliente sul processo."
    },
    "ricavi": {
      "1-2": "Rivedi il pricing per fascia di cliente e volume — molti distributori applicano listino fisso perdendo margine sui grandi e lasciando soldi sul tavolo con i piccoli.",
      "2-3": "Proponi accordi di fornitura esclusiva o preferenziale con i clienti principali — volume garantito in cambio di prezzi stabili.",
      "3-4": "Sviluppa servizi a valore aggiunto: consegna just-in-time, magazzino conto deposito, kitting — margini superiori alla pura distribuzione.",
      "4-5": "Contratti annuali con revisione prezzi semiannuale e bonus volume — protegge i margini e fidelizza i grandi account."
    },
    "marketing": {
      "1-2": "Aggiorna il catalogo prodotti digitale e invia newsletter mensile ai clienti attivi con novità di prodotto e promozioni — ~50-200€/mese.",
      "2-3": "Partecipa a fiere di settore industriale (MECSPE, BI-MU, ~2.000-6.000€) — visibilità con buyer industriali qualificati.",
      "3-4": "Campagne LinkedIn Ads su responsabili acquisti e produzione delle aziende target (~400-1.000€/mese).",
      "4-5": "Strategia account based marketing: contenuto personalizzato per settore, visite personalizzate, offerte dedicate per i top account."
    },
    "sitoweb": {
      "1-2": "Sito con catalogo prodotti, schede tecniche scaricabili e richiesta preventivo online — ~1.000-2.500€.",
      "2-3": "Area riservata per clienti con accesso a prezzi riservati, storico ordini e documentazione tecnica.",
      "3-4": "E-catalogue aggiornato in tempo reale con disponibilità stock e tempi di consegna — riduce le telefonate per lo stock.",
      "4-5": "Portale B2B con inserimento ordini, tracking spedizioni e integrazione ERP cliente — standard per i distributori strutturati."
    },
    "ecommerce": {
      "1-2": "E-commerce B2B per prodotti standard a catalogo — ordini piccoli automatizzati senza impegno commerciale (~500-2.000€/mese).",
      "2-3": "Marketplace industriali (Mercateo, Amazon Business) per aumentare la visibilità su clienti non ancora nel tuo portafoglio.",
      "3-4": "Piattaforma ordini B2B con listini personalizzati per cliente, approvazione ordini multi-livello e fatturazione automatica.",
      "4-5": "Integrazione API con i sistemi ERP dei clienti principali per riordino automatico delle scorte minime."
    }
  },
  "commercio_ingrosso_alimentare": {
    "vendite": {
      "1-2": "Mappa i 20 clienti HORECA e retail con maggior potenziale inespresso — visita settimanale sistematica, nessun costo aggiuntivo.",
      "2-3": "Attiva agenti con portafoglio HORECA o retail food della zona (~provvigione 4-7% sul fatturato) — operativo in 2-4 settimane.",
      "3-4": "Assumi un key account manager (~2.500-3.500€/mese) dedicato ai clienti GDO e alle catene HORECA strutturate.",
      "4-5": "Struttura commerciale per canale: KAM GDO + agenti HORECA + inside sales per i clienti minori."
    },
    "pipeline": {
      "1-2": "Traccia ordini e trattative per cliente su Excel — monitora la frequenza di riordino e segnala i clienti che stanno comprando meno.",
      "2-3": "CRM semplice con alert per riordini attesi e clienti inattivi da +30 giorni (~30-80€/mese) — recupero clienti dormienti immediato.",
      "3-4": "Analisi ABC clienti mensile — focus del 70% del tempo commerciale sull'80% del fatturato.",
      "4-5": "CRM integrato con ERP per gestione ordini, previsioni di vendita e pianificazione acquisti fornitori."
    },
    "team": {
      "1-2": "Forma gli agenti sulle caratteristiche organolettiche e di origine dei prodotti — chi vende food deve sapere raccontare il prodotto.",
      "2-3": "Struttura un piano provvigionale con bonus su nuovi clienti acquisiti e su clienti recuperati dopo inattività.",
      "3-4": "Affianca un inside sales agli agenti di campo (~1.500-2.000€/mese) per la gestione degli ordini ripetitivi.",
      "4-5": "Sales manager che coordina la rete, monitora KPI e gestisce i key account GDO e le catene principali."
    },
    "processi": {
      "1-2": "Standardizza la gestione degli ordini urgenti e delle rotture di stock — la reattività nel food è critica, il cliente non aspetta.",
      "2-3": "Implementa il sistema di tracciabilità obbligatoria (Reg. CE 178/2002) in modo efficiente — richiede ~500-2.000€ di software.",
      "3-4": "Gestionale magazzino con FIFO rigoroso, gestione scadenze e allerta automatica per prodotti in scadenza (~200-500€/mese).",
      "4-5": "WMS (Warehouse Management System) integrato con ordini e trasporti — riduce gli errori di spedizione e ottimizza il magazzino."
    },
    "ricavi": {
      "1-2": "Rivedi il pricing per categoria prodotto e volume cliente — nel food il margine varia molto tra prodotti freschi, secchi e surgelati.",
      "2-3": "Proponi accordi di fornitura preferenziale con i clienti HORECA principali — volume garantito in cambio di prezzi stabili.",
      "3-4": "Sviluppa linee private label o prodotti esclusivi per i clienti principali — differenziazione e margini superiori.",
      "4-5": "Contratti annuali con GDO e catene HORECA con clausole di revisione prezzi legate agli indici materie prime."
    },
    "marketing": {
      "1-2": "Catalogo digitale aggiornato con schede prodotto, origine, certificazioni e prezzi — inviato mensilmente ai clienti attivi.",
      "2-3": "Partecipa a Cibus, SIAL o fiere HORECA regionali (~2.000-6.000€) — contatti diretti con buyer GDO e responsabili acquisti HORECA.",
      "3-4": "Newsletter food con ricette, abbinamenti e stagionalità dei prodotti — content marketing che fidelizza i clienti HORECA.",
      "4-5": "Strategia digitale B2B: LinkedIn per GDO e catene + Instagram per il posizionamento brand con i ristoratori."
    },
    "sitoweb": {
      "1-2": "Sito con catalogo prodotti, schede tecniche e richiesta preventivo/listino — ~800-2.000€.",
      "2-3": "Area riservata clienti con listini aggiornati, schede tecniche e modulo ordini online.",
      "3-4": "E-catalogue in tempo reale con disponibilità, scadenze e tempi di consegna — riduce le telefonate.",
      "4-5": "Portale B2B completo con inserimento ordini, storico e integrazione con ERP del cliente."
    },
    "ecommerce": {
      "1-2": "Piattaforma ordini online semplice per i clienti abituali — riduce il carico telefonico e gli errori di ordine (~200-500€/mese).",
      "2-3": "App mobile per agenti con catalogo, stock e inserimento ordini in tempo reale — aumenta la produttività sul campo.",
      "3-4": "Marketplace food B2B (Alimenta, Stockmercato) per raggiungere nuovi clienti HORECA fuori zona.",
      "4-5": "Integrazione API con i sistemi degli acquisti GDO — ordini automatici su base contratto annuale."
    }
  },
  "commercio_materiali_edili": {
    "vendite": {
      "1-2": "Visita sistematica delle imprese edili della zona — mappa chi compra e chi non ha ancora mai acquistato da te. Nessun costo.",
      "2-3": "Attiva 1-2 agenti con portafoglio imprese edili e geometri (~provvigione 3-6%) — operativo in 2-4 settimane.",
      "3-4": "Assumi un commerciale interno (~2.000-3.000€/mese) per presidiare i clienti strategici e sviluppare nuovi account.",
      "4-5": "Struttura commerciale per canale: KAM imprese strutturate + agenti per le piccole + inside sales per i privati."
    },
    "pipeline": {
      "1-2": "Traccia i preventivi aperti su Excel — chi richiede preventivo e non ordina entro 2 settimane va ricontattato.",
      "2-3": "CRM base per gestire preventivi, follow-up e storico cliente (~30-60€/mese) — operativo in 1 settimana.",
      "3-4": "Analisi stagionalità ordini per pianificare gli acquisti in anticipo e ridurre le rotture di stock nei periodi di punta.",
      "4-5": "CRM integrato con gestione preventivi, stock e ordini automatici ai fornitori."
    },
    "team": {
      "1-2": "Forma gli addetti al banco sulla consulenza tecnica — il cliente che riceve un consiglio competente torna e compra di più.",
      "2-3": "Struttura incentivi per il personale di vendita legati al cross-selling e alla marginalità — non solo ai volumi.",
      "3-4": "Assumi un responsabile commerciale (~2.000-3.000€/mese) che coordina gli agenti e gestisce i cantieri principali.",
      "4-5": "Team strutturato: commerciale esterno + banco vendita specializzato + back office preventivi."
    },
    "processi": {
      "1-2": "Standardizza i preventivi con computo materiali dettagliato, tempi di consegna garantiti e condizioni di reso.",
      "2-3": "Gestionale magazzino per controllo stock, riordini automatici e gestione resi — evita rotture di stock sui prodotti ad alta rotazione.",
      "3-4": "Software preventivazione edilizia integrato con il gestionale (~150-400€/mese) — velocizza i preventivi per i cantieri.",
      "4-5": "Sistema integrato: ERP + CRM + e-commerce B2B — gestione completa dal preventivo alla fattura."
    },
    "ricavi": {
      "1-2": "Rivedi i margini per categoria prodotto — nel materiale edile i margini variano molto tra commodity e prodotti specialistici.",
      "2-3": "Proponi il servizio di consegna cantiere programmata — il cliente paga la comodità, i margini migliorano.",
      "3-4": "Sviluppa linee private label o accordi di esclusiva territoriale con produttori — differenziazione e margini protetti.",
      "4-5": "Contratti di fornitura annuale con le imprese edili strutturate — volume garantito e margini stabili."
    },
    "marketing": {
      "1-2": "Google My Business aggiornato con orari, catalogo e recensioni — genera lead locali da privati e piccole imprese.",
      "2-3": "Catalogo digitale aggiornato inviato mensilmente alle imprese edili della zona — ~100-300€/mese.",
      "3-4": "Presenza su portali edilizia e costruzioni (Edilportale, Infobuild) — visibilità con professionisti e imprese strutturate.",
      "4-5": "Fiere di settore locali + campagne digitali B2B su imprese edili e studi tecnici."
    },
    "sitoweb": {
      "1-2": "Sito base con catalogo prodotti, disponibilità e richiesta preventivo — ~800-2.000€.",
      "2-3": "Catalogo online con prezzi riservati per clienti registrati e modulo ordini.",
      "3-4": "E-catalogue in tempo reale con stock, prezzi e tempi di consegna — riduce le telefonate da cantiere.",
      "4-5": "Portale B2B per imprese: ordini, tracking consegne, fatturazione e storico acquisti."
    },
    "ecommerce": {
      "1-2": "Piattaforma ordini online per i clienti abituali — riduce il carico telefonico e gli errori (~200-500€/mese).",
      "2-3": "App mobile per cantieristi — ordinare dal cantiere in tempo reale senza passare in negozio.",
      "3-4": "Marketplace edilizia (Edilportale Shop, Leroy Merlin Pro) per raggiungere nuovi clienti.",
      "4-5": "Integrazione con i sistemi gestionali delle imprese edili clienti principali — ordini automatici su base contratto."
    }
  },
  "commercio_ricambi_auto": {
    "vendite": {
      "1-2": "Visita sistematica le officine e i carrozzieri della zona — mappa chi compra e chi compra dai competitor. Nessun costo.",
      "2-3": "Attiva 1-2 agenti con portafoglio officine e flotte (~provvigione 4-7%) — operativo in 2-4 settimane.",
      "3-4": "Assumi un commerciale interno (~2.000-3.000€/mese) per presidiare i clienti strategici e sviluppare flotte e carrozzerie.",
      "4-5": "Struttura commerciale per segmento: KAM flotte + agenti per officine + inside sales per i privati."
    },
    "pipeline": {
      "1-2": "Traccia i preventivi aperti su Excel — officine e carrozzerie decidono in giornata, il follow-up deve essere immediato.",
      "2-3": "CRM con gestione preventivi rapida e storico per targa/modello — il cliente vuole sapere se hai il pezzo e in quanto tempo (~30-80€/mese).",
      "3-4": "Monitora il tasso di riordino per cliente — chi compra sempre lo stesso marca/modello va fidelizzato con accordi di fornitura.",
      "4-5": "CRM integrato con ERP per disponibilità stock real-time, ordini fornitori e tracking consegne."
    },
    "team": {
      "1-2": "Forma il personale sul banco sulla ricerca rapida dei ricambi — velocità e competenza tecnica sono il tuo vantaggio competitivo.",
      "2-3": "Struttura incentivi per chi sviluppa nuovi clienti officina e chi recupera clienti inattivi.",
      "3-4": "Assumi un addetto dedicato alle flotte aziendali (~1.800-2.500€/mese) — cliente ricorrente e prevedibile.",
      "4-5": "Team strutturato: commerciale esterno + banco tecnico specializzato + gestione flotte e carrozzerie."
    },
    "processi": {
      "1-2": "Standardizza i tempi di risposta alle richieste: max 30 minuti per ricambi a stock, max 2h per ricambi da ordinare.",
      "2-3": "Gestionale ricambi auto (TecDoc, Autodata integrati, ~200-500€/mese) — ricerca rapida per targa e codice OEM.",
      "3-4": "Processo di gestione resi e garanzie strutturato — le officine vogliono zero problemi con i resi.",
      "4-5": "WMS integrato con i principali cataloghi ricambi (TecDoc, Nexus) per ordini automatici ai fornitori."
    },
    "ricavi": {
      "1-2": "Rivedi il pricing per categoria (OEM vs aftermarket) e per cliente — officine strutturate hanno margini diversi dai privati.",
      "2-3": "Proponi accordi di fornitura preferenziale alle officine principali — volume garantito in cambio di prezzi stabili.",
      "3-4": "Sviluppa la vendita di accessori e prodotti di consumo (lubrificanti, batterie, pneumatici) — margini superiori ai ricambi.",
      "4-5": "Contratti di fornitura annuale con flotte aziendali e carrozzerie strutturate — ricavo ricorrente prevedibile."
    },
    "marketing": {
      "1-2": "Google My Business con orari, catalogo marchi trattati e recensioni officine — lead locali qualificati.",
      "2-3": "Newsletter mensile alle officine con promozioni su ricambi ad alta rotazione e novità di prodotto.",
      "3-4": "Presenza su portali ricambi (Meca, Parts Alliance) per visibilità con officine fuori zona.",
      "4-5": "Strategia digitale B2B: campagne su officine e flotte + presenza fiere settore (Autopromotec)."
    },
    "sitoweb": {
      "1-2": "Sito con catalogo marchi, ricerca per targa e richiesta disponibilità — ~800-2.000€.",
      "2-3": "E-catalogue con ricerca per targa/codice OEM e disponibilità stock in tempo reale.",
      "3-4": "Portale B2B per officine con prezzi riservati, ordini online e storico acquisti.",
      "4-5": "Integrazione con i sistemi gestionali delle officine clienti — ordini automatici su scorta minima."
    },
    "ecommerce": {
      "1-2": "Piattaforma ordini online per officine abituali — riduce il carico telefonico del banco.",
      "2-3": "App mobile per officine — ordinare il ricambio direttamente dall'auto in riparazione.",
      "3-4": "Marketplace ricambi (Mister Auto Pro, Autodoc Pro) per raggiungere officine fuori zona.",
      "4-5": "Integrazione API con i DMS delle officine principali — ordini automatici integrati nel loro gestionale."
    }
  },
  "commercio_abbigliamento_ingrosso": {
    "vendite": {
      "1-2": "Visita i dettaglianti e i multimarca della tua zona con il campionario stagionale — il contatto fisico nel fashion è ancora il canale principale.",
      "2-3": "Attiva 1-2 agenti plurimandatari con portafoglio buyer nel tuo segmento (casual, sportswear, occasioni) (~provvigione 8-12%) — operativo in 1-2 mesi.",
      "3-4": "Assumi un commerciale con esperienza moda (~2.500-3.500€/mese) per i clienti strategici e lo sviluppo export.",
      "4-5": "Struttura commerciale per area geografica + showroom fisso per la campagna vendite stagionale."
    },
    "pipeline": {
      "1-2": "Traccia gli ordini per stagione per cliente su Excel — monitora chi ha ordinato, chi no e chi sta ordinando meno rispetto alla stagione precedente.",
      "2-3": "CRM con gestione campagne stagionali (PE/AI) e follow-up strutturato — il fashion ha scadenze rigide (~30-80€/mese).",
      "3-4": "Monitora il conversion rate visita/ordine per agente e per stagione — ottimizza l'efficacia della rete commerciale.",
      "4-5": "CRM integrato con gestione ordini, conferme e pianificazione spedizioni stagionali."
    },
    "team": {
      "1-2": "Forma gli agenti sulle caratteristiche del campionario — tessuti, vestibilità, target cliente — devono saper raccontare la collezione.",
      "2-3": "Struttura incentivi per campagna: bonus su ordini sopra soglia e su nuovi clienti acquisiti.",
      "3-4": "Showroom manager (~1.800-2.500€/mese) per la gestione delle campagne vendite e la relazione con i buyer.",
      "4-5": "Team completo: direttore commerciale + agenti di zona + showroom manager + back office ordini."
    },
    "processi": {
      "1-2": "Standardizza il processo di campagna: presentazione campionario, raccolta ordini, conferme e spedizioni — tempi garantiti.",
      "2-3": "Software gestione ordini moda (Orderchamp, NuOrder, ~100-300€/mese) — raccolta ordini digitale durante la campagna.",
      "3-4": "Processo di gestione resi e invenduto — le condizioni devono essere chiare prima della campagna, non dopo.",
      "4-5": "PLM/OMS integrato per la gestione completa dalla campagna alla spedizione — standard dei grossisti strutturati."
    },
    "ricavi": {
      "1-2": "Rivedi le condizioni di pagamento — anticipi alla conferma ordine proteggono il cash flow e scoraggiano gli ordini speculativi.",
      "2-3": "Proponi servizi di visual merchandising ai retailer principali — consulenza gratuita che fidelizza e aumenta il sell-out.",
      "3-4": "Sviluppa una linea private label esclusiva per i clienti più importanti — margini superiori e fidelizzazione.",
      "4-5": "Contratti di fornitura stagionale con garanzia di riassortimento — il retailer non rimane mai senza best seller."
    },
    "marketing": {
      "1-2": "Partecipa a White Milano, Pitti o fiere regionali di settore (~2.000-8.000€) — il fashion si vende ancora alle fiere.",
      "2-3": "Showroom fisso a Milano o nella tua città per la campagna stagionale (~1.000-2.500€/mese durante la campagna).",
      "3-4": "Instagram e Pinterest con le collezioni fotografate professionalmente — i buyer cercano ispirazione sui social.",
      "4-5": "Strategia di brand building: press release, fashion blogger, influencer B2B nel retail moda."
    },
    "sitoweb": {
      "1-2": "Sito con catalogo stagionale, condizioni di acquisto e form contatto per i buyer.",
      "2-3": "Showroom digitale con foto professionali della collezione e area riservata per buyer registrati.",
      "3-4": "Piattaforma B2B per raccolta ordini online durante la campagna — riduce il lavoro amministrativo.",
      "4-5": "Portale buyer con gestione ordini, tracking spedizioni, schede tecniche e storico stagioni."
    },
    "ecommerce": {
      "1-2": "Iscriviti a Orderchamp, Faire o marketplace grossisti moda — visibilità con buyer che non conosci ancora.",
      "2-3": "Piattaforma ordini online per i riassortimenti fuori campagna — il cliente riordina i best seller quando vuole.",
      "3-4": "Canale B2C diretto per l'invenduto — stock a fine stagione venduto direttamente al consumatore finale.",
      "4-5": "Integrazione digitale con i sistemi dei retailer principali — gestione riassortimenti automatica."
    }
  },
  "commercio_elettronica": {
    "vendite": {
      "1-2": "Forma il personale sull'accoglienza attiva e sulla consulenza tecnica — il cliente che riceve un consiglio competente compra di più e torna. Nessun costo.",
      "2-3": "Struttura obiettivi individuali per il personale: scontrino medio, accessori venduti per prodotto principale, tasso di conversione — incentivo mensile (~200-400€ bonus pool).",
      "3-4": "Assumi un responsabile vendite o store manager (~2.000-3.000€/mese) che coordina il team, monitora i KPI e gestisce i clienti business.",
      "4-5": "Struttura multi-store o multi-canale: responsabile per punto vendita + coordinatore e-commerce + key account per i clienti business e flotte."
    },
    "pipeline": {
      "1-2": "Traccia le richieste di preventivo B2B su Excel — aziende, scuole e enti che acquistano in quantità sono il tuo canale a margini più alti.",
      "2-3": "CRM base per gestire i clienti business con follow-up strutturato (~30-60€/mese) — un cliente business vale 10 clienti privati.",
      "3-4": "Implementa un sistema di fidelizzazione clienti (carta fedeltà, punti, cashback) — aumenta la frequenza di acquisto e il lifetime value.",
      "4-5": "CRM integrato con e-commerce e POS — visione unica del cliente su tutti i canali."
    },
    "team": {
      "1-2": "Forma il personale sui prodotti e sulle tecniche di cross-selling: cuffiette con smartphone, cover con tablet, cavi con laptop — nessun costo.",
      "2-3": "Struttura un piano di incentivi legato al cross-selling e alla marginalità — non solo ai volumi.",
      "3-4": "Affianca un tecnico-riparatore (~1.500-2.000€/mese) — l'assistenza tecnica fidelizza il cliente e genera ricavi aggiuntivi.",
      "4-5": "Team strutturato: store manager + specialisti per categoria (telefonia, computer, audio/video) + tecnico assistenza."
    },
    "processi": {
      "1-2": "Standardizza il processo di accoglienza e vendita: accoglienza, qualificazione bisogno, proposta, gestione obiezione, chiusura — training 1 giornata.",
      "2-3": "Gestionale POS con controllo stock, riordini automatici e analisi vendite per prodotto (~100-300€/mese) — elimina le rotture di stock sui best seller.",
      "3-4": "Processo di assistenza tecnica strutturato: accettazione, diagnosi, preventivo, riparazione, collaudo, consegna — genera fiducia e ricavi.",
      "4-5": "Sistema integrato POS + e-commerce + magazzino + CRM — visione completa su tutti i canali di vendita."
    },
    "ricavi": {
      "1-2": "Proponi sistematicamente la garanzia estesa su ogni prodotto venduto — margini 40-60% superiori al prodotto principale.",
      "2-3": "Sviluppa la divisione B2B: forniture per aziende, scuole, enti pubblici (~ordinativi 2.000-20.000€) — margini più alti e clienti ricorrenti.",
      "3-4": "Attiva un servizio di assistenza tecnica e noleggio operativo — ricavo ricorrente mensile prevedibile.",
      "4-5": "Contratti di fornitura con aziende e PA per aggiornamento parco informatico — volumi garantiti annuali."
    },
    "marketing": {
      "1-2": "Google My Business ottimizzato con orari, prodotti principali e recensioni — genera traffico locale qualificato.",
      "2-3": "Campagne social (Facebook/Instagram) con promozioni settimanali sui prodotti ad alta rotazione (~300-700€/mese).",
      "3-4": "Google Shopping e campagne Google Ads per intercettare chi cerca il prodotto online (~500-1.500€/mese).",
      "4-5": "Strategia omnicanale: social + SEO + Google Ads + newsletter + loyalty program — presidio completo del cliente."
    },
    "sitoweb": {
      "1-2": "Sito base con catalogo prodotti, disponibilità e contatti — ~800-2.000€.",
      "2-3": "E-commerce base con i prodotti più venduti e pagamento online (~2.000-5.000€ + ~100-200€/mese).",
      "3-4": "E-commerce avanzato con stock in tempo reale, ritiro in negozio e area clienti.",
      "4-5": "Piattaforma omnicanale: sito + app + POS integrati — esperienza cliente uniforme su tutti i touchpoint."
    },
    "ecommerce": {
      "1-2": "Iscriviti a Subito, eBay o Marketplace Facebook per vendere prodotti usati e ricondizionati — canale a margini interessanti.",
      "2-3": "Apri un negozio su Amazon o eBay per i prodotti a catalogo — visibilità immediata senza investimenti in SEO (~15-20% commissione).",
      "3-4": "E-commerce proprietario con SEO e Google Shopping — riduce la dipendenza dai marketplace.",
      "4-5": "Strategia marketplace + sito proprietario + canale B2B — diversificazione completa dei canali di vendita."
    }
  },
  "commercio_auto_moto_nuovo": {
    "vendite": {
      "1-2": "Struttura l'accoglienza in showroom: saluto professionale, proposta test drive, brochure aggiornate e follow-up entro 24h dalla visita — training interno, nessun costo.",
      "2-3": "Assumi un venditore con esperienza brand (~2.500-3.500€/mese) che gestisce trattative, finanziamenti e consegne in autonomia — operativo in 2-3 mesi.",
      "3-4": "Struttura un team vendite con responsabile (~3.500-4.500€/mese) che gestisce venditori per segmento: privati, flotte aziendali, km0.",
      "4-5": "Direzione commerciale strutturata: responsabile vendite + venditori per segmento + fleet manager + coordinatore post-vendita."
    },
    "pipeline": {
      "1-2": "Traccia ogni lead e visita su Excel: cliente, modello di interesse, budget, stato trattativa — ciclo vendita nuovo è 15-45 giorni.",
      "2-3": "CRM automotive (es. DealerSocket, Vistadeal, ~200-400€/mese) per gestire lead da sito, portali e showroom con follow-up strutturato.",
      "3-4": "Lead nurturing automatico via email/SMS per i clienti che hanno visitato ma non acquistato — recupero trattative fredde.",
      "4-5": "DMS integrato con casa madre per gestione allocazioni, ordini, configuratori e forecast mensile."
    },
    "team": {
      "1-2": "Formazione prodotto obbligatoria: ogni venditore deve conoscere perfettamente gamma, optional e argomenti di vendita — formazione casa madre.",
      "2-3": "Piano incentivi strutturato: bonus per unità vendute, penetrazione finanziaria e soddisfazione cliente (NPS).",
      "3-4": "Affianca un F&I manager (Finance & Insurance, ~2.000-3.000€/mese) — massimizza i ricavi da finanziamento, assicurazione e accessori.",
      "4-5": "Sales manager che coordina il team, gestisce gli obiettivi mensili e mantiene i rapporti con i fleet clienti."
    },
    "processi": {
      "1-2": "Standardizza il processo dalla visita alla consegna: accoglienza, configurazione, preventivo, finanziamento, ordine, consegna — tempi garantiti.",
      "2-3": "Implementa il processo di gestione delle permute: valutazione standardizzata con Eurotax + fotografia + decisione entro 24h.",
      "3-4": "DMS (Dealer Management System, ~500-1.500€/mese) per gestione ordini, stock, pratiche e fatturazione — integrazione con casa madre.",
      "4-5": "Processo completo digitale: firma contratto digitale, pratiche online, aggiornamento automatico del cliente sullo stato ordine."
    },
    "ricavi": {
      "1-2": "Proponi sistematicamente finanziamento, garanzia estesa e accessori su ogni trattativa — upsell immediato con margini elevati.",
      "2-3": "Sviluppa accordi con finanziarie per obiettivi di penetrazione mensili — bonus sul raggiungimento degli obiettivi.",
      "3-4": "Fleet management: accordi con aziende per forniture ricorrenti di vetture aziendali — ricavo prevedibile e clienti fidelizzati.",
      "4-5": "Revenue management completo: mix km0/nuovo/usato ottimizzato + obiettivi di penetrazione finanziaria + after sales strutturato."
    },
    "marketing": {
      "1-2": "Google My Business ottimizzato con foto showroom, stock disponibile e recensioni — genera lead locali qualificati.",
      "2-3": "Campagne Google Ads locali su modelli + zona (~500-1.500€/mese) + presenza portali auto (AutoScout, Motor.it).",
      "3-4": "Strategia social: Instagram con video test drive e lifestyle del brand + campagne Meta Ads sul target locale.",
      "4-5": "Marketing integrato: digital + eventi + partnership con aziende per fleet + programma referral strutturato."
    },
    "sitoweb": {
      "1-2": "Sito con stock disponibile, configuratore e richiesta test drive online — ~1.500-3.000€.",
      "2-3": "Sito avanzato con chat live, preventivo online e integrazione con il configuratore della casa madre.",
      "3-4": "Integrazione sito con DMS: stock aggiornato in tempo reale, lead automatici al CRM, tracking campagne.",
      "4-5": "Esperienza digitale premium: tour virtuale showroom, acquisto online, firma digitale e consegna a domicilio."
    },
    "ecommerce": {
      "1-2": "Presenza attiva su AutoScout24 e Motor.it con schede complete e foto professionali per ogni vettura disponibile.",
      "2-3": "Attiva la vendita km0 e usati certificati online — canale con margini interessanti e clienti già qualificati.",
      "3-4": "Piattaforma vendita digitale: prenotazione online, configuratore, preventivo immediato e acquisto con anticipo.",
      "4-5": "Full digital retail: acquisto 100% online con consegna a domicilio — standard richiesto dai brand premium."
    }
  },
  ...
  "commercio_abbigliamento_dettaglio": {
    "vendite": {
      "1-2": "Forma il personale sull'accoglienza attiva e il coordinamento outfit — il cliente che riceve un consiglio di stile compra 2-3 capi invece di 1. Training interno, nessun costo.",
      "2-3": "Struttura obiettivi individuali: scontrino medio, nr capi per scontrino, tasso di conversione — incentivo mensile (~200-400€ bonus pool).",
      "3-4": "Assumi uno store manager (~2.000-3.000€/mese) che coordina il team, gestisce i riordini e sviluppa i clienti VIP.",
      "4-5": "Struttura multi-store o multi-canale: store manager per punto vendita + e-commerce manager + eventi e collaborazioni."
    },
    "pipeline": {
      "1-2": "Crea un registro clienti VIP con nome, gusto, taglie e storico acquisti — il cliente che si sente ricordato torna.",
      "2-3": "CRM o app fidelizzazione (~30-80€/mese) con storico acquisti, preferenze e alert per nuovi arrivi nel loro stile.",
      "3-4": "Programma VIP strutturato: accesso anticipato ai nuovi arrivi, eventi privati, styling service dedicato.",
      "4-5": "CRM integrato con e-commerce e POS — visione unica del cliente su tutti i canali."
    },
    "team": {
      "1-2": "Forma il personale su tecniche di upselling e cross-selling nel fashion: proponi sempre una giacca con i pantaloni, una borsa con il vestito.",
      "2-3": "Struttura incentivi legati allo scontrino medio e al tasso di conversione — non solo alle ore lavorate.",
      "3-4": "Organizza sessioni di styling interno mensili per mantenere alta la conoscenza del prodotto e la motivazione.",
      "4-5": "Team strutturato con store manager, visual merchandiser e addetto e-commerce — copertura completa su tutti i canali."
    },
    "processi": {
      "1-2": "Standardizza il visual merchandising: esposizione per outfit completi, non per singolo capo — aumenta lo scontrino medio.",
      "2-3": "Gestionale moda con controllo stock per taglia e colore, analisi sell-through e riordini automatici (~100-250€/mese).",
      "3-4": "Processo di gestione dei resi e degli invenduti: sconti progressivi, outlet, donazioni — evita lo stock morto.",
      "4-5": "Sistema integrato: POS + e-commerce + gestione acquisti — controllo completo dalla campagna alla vendita."
    },
    "ricavi": {
      "1-2": "Proponi sempre il coordinato completo: capi abbinati, accessori, calzature — scontrino medio +40-60%.",
      "2-3": "Attiva un programma fedeltà con punti e premi — aumenta la frequenza di visita e il lifetime value del cliente.",
      "3-4": "Organizza eventi privati per clienti VIP: nuovi arrivi in anteprima, styling party, capsule collection esclusive.",
      "4-5": "Personal shopping service e styling consulenza a pagamento — posizionamento premium e ricavo aggiuntivo."
    },
    "marketing": {
      "1-2": "Instagram e Facebook con foto dei nuovi arrivi e outfit del giorno (~300-600€/mese gestione social) — traffico in negozio.",
      "2-3": "Collaborazioni con influencer locali e micro-influencer (~200-500€ per post) — awareness locale qualificata.",
      "3-4": "Campagne Meta Ads geolocalizzate per intercettare clienti nella tua zona (~400-1.000€/mese).",
      "4-5": "Strategia omnicanale: social + newsletter + loyalty app + eventi — presidio completo del cliente."
    },
    "sitoweb": {
      "1-2": "Profilo Instagram curato con foto professionali — per il fashion retail è più importante del sito.",
      "2-3": "E-commerce base con i pezzi forti della collezione (~2.000-4.000€) — vendita anche fuori orario e zona.",
      "3-4": "E-commerce completo con tutta la collezione, taglia guide e reso gratuito.",
      "4-5": "Piattaforma omnicanale con click-and-collect, wishlist e raccomandazioni personalizzate."
    },
    "ecommerce": {
      "1-2": "Vendi su Vinted o Depop i capi di stagione precedente — recupero liquidità e nuovi clienti.",
      "2-3": "Apertura su Zalando Partner Program o YOOX — visibilità immediata su marketplace fashion.",
      "3-4": "E-commerce proprietario con SEO fashion e campagne social — riduce la dipendenza dai marketplace.",
      "4-5": "Strategia multicanale: sito proprietario + marketplace + social commerce — massima copertura."
    }
  },
  "commercio_orologi_gioielli": {
    "vendite": {
      "1-2": "Forma il personale sulla narrazione del prodotto: storia del brand, materiali, artigianalità — il cliente del lusso compra una storia, non un oggetto. Nessun costo.",
      "2-3": "Struttura un processo di vendita consulenziale: capire l'occasione (regalo, anniversario, status) e proporre la soluzione giusta — training 1-2 giornate.",
      "3-4": "Assumi un gioielliere/orologiaio con esperienza commerciale (~2.500-3.500€/mese) che gestisce i clienti VIP e i pezzi importanti.",
      "4-5": "Struttura commerciale: responsabile vendite VIP + e-commerce manager + key account per aziende (premi, gadget istituzionali)."
    },
    "pipeline": {
      "1-2": "Crea un registro clienti VIP con occasioni speciali: compleanni, anniversari, ricorrenze — contattali sempre 30 giorni prima.",
      "2-3": "CRM con gestione occasioni e reminder automatici (~30-80€/mese) — il cliente ricordato è il cliente fidelizzato.",
      "3-4": "Programma VIP strutturato: accesso privato a nuovi arrivi, eventi esclusivi, servizio di personalizzazione.",
      "4-5": "CRM integrato con storico acquisti, preferenze e budget cliente — consulenza personalizzata su ogni visita."
    },
    "team": {
      "1-2": "Forma il personale sulla certificazione dei materiali (oro, argento, pietre preziose) e sull'autenticità dei brand — competenza è sinonimo di fiducia.",
      "2-3": "Affianca un orologiaio/gioielliere tecnico (~1.800-2.500€/mese) — l'assistenza tecnica fidelizza e genera ricavi aggiuntivi.",
      "3-4": "Struttura incentivi per il personale legati al valore del venduto e alla soddisfazione cliente — non solo ai volumi.",
      "4-5": "Team specializzato: vendite VIP + tecnico riparazioni + addetto e-commerce + responsabile acquisti."
    },
    "processi": {
      "1-2": "Standardizza il processo di accoglienza VIP: apertura con champagne o caffè, nessuna fretta, massima attenzione — costo minimo, impatto massimo.",
      "2-3": "Gestionale gioielleria con inventario per pezzo, certificati GIA e garanzie (~200-500€/mese) — tracciabilità obbligatoria.",
      "3-4": "Processo di acquisto usato e permuta strutturato — molti clienti hanno gioielli da valorizzare, è un canale di acquisizione potente.",
      "4-5": "Sistema integrato: inventario + CRM + e-commerce + gestione certificazioni — controllo completo sulla merce e sui clienti."
    },
    "ricavi": {
      "1-2": "Proponi sistematicamente il servizio di pulizia e controllo gioielli esistenti — contatto con il cliente, cross-selling naturale.",
      "2-3": "Sviluppa il servizio di personalizzazione: incisioni, modifiche, rimontaggi — margini 60-80% superiori alla vendita standard.",
      "3-4": "Attiva un servizio di acquisto usato strutturato — il cliente che vende riceve buoni acquisto e torna.",
      "4-5": "Contratti con aziende per premi e gadget istituzionali — ordini multipli ad alto valore, clienti B2B ricorrenti."
    },
    "marketing": {
      "1-2": "Instagram con foto professionali dei pezzi e storytelling del brand — nel lusso la qualità visiva è tutto.",
      "2-3": "Collaborazioni con wedding planner e organizzatori eventi per essere consigliati nelle occasioni speciali — referenze B2B.",
      "3-4": "Campagne Meta Ads su target alto spendente nella tua zona (~400-1.000€/mese) + eventi privati in boutique.",
      "4-5": "Strategia luxury marketing: eventi esclusivi, PR, presenza su riviste locali e partnership con hotel e ristoranti premium."
    },
    "sitoweb": {
      "1-2": "Sito con gallery pezzi selezionati, brand trattati e contatti — nel lusso il sito deve respirare qualità.",
      "2-3": "E-commerce per pezzi selezionati con foto professionali e certificati scaricabili (~3.000-8.000€).",
      "3-4": "Sito con configuratore personalizzazioni e area clienti VIP — esperienza digitale coerente con quella in boutique.",
      "4-5": "Piattaforma luxury e-commerce con consulenza online, video call con il gioielliere e consegna white glove."
    },
    "ecommerce": {
      "1-2": "Profilo su Chrono24 per orologi di seconda mano — marketplace verticale con buyer qualificati.",
      "2-3": "Presenza su Farfetch o Catawiki per orologi e gioielli vintage — visibilità internazionale immediata.",
      "3-4": "E-commerce proprietario con SEO luxury e campagne Google Shopping.",
      "4-5": "Strategia multicanale: sito proprietario + marketplace luxury + social commerce — massima copertura del target."
    }
  },
